...
describe Billymad::ClientTag do
  ...
  it "has correct .resource_name" do
    expect(described_class.send(:resource_name)).to eq('client-tag')
  end

  it "has correct .plural_resource_name" do
    expect(described_class.send(:plural_resource_name)).to eq('client-tags')
  end
end