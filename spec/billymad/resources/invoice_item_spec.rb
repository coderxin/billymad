...
describe Billymad::InvoiceItem do
  ...
  it 'has correct .resource_name' do
    expect(described_class.send(:resource_name)).to eq('invoice-item')
  end

  it 'has correct .plural_resource_name' do
    expect(described_class.send(:plural_resource_name)).to eq('invoice-items')
  end
end
